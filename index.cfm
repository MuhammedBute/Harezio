	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
				...
				<div class="m-header">
					...
					<a href="#!" class="b-brand">
                        <img src="assets/images/beyaz_harezyo.png" alt="" class="logo">
					</a>
							...
							<div class="dropdown mega-menu">
                                ...
                                <li class="nav-item">
                                    <a href="#!" class="pop-search"><i class="feather icon-search"></i></a>
                                        ...
                                        <input type="text" class="form-control border-0 shadow-none" placeholder="">
                                        <button ton type="button" class="close" aria-label="Close">
